...
class V1Dot1Dot33 extends Base
{
    /**
     * @inheritDoc
     */
    public function up(): void
    {
        $this->getPDO()->exec(
            ...
            . " ('" . Util::generateId() . "','PC Configurations update', 'ConfigurationsUpdateCron', 'Active', '0 2 * * *')"
        );
    }
    ...
    public function down(): void
    {
        ...
        $this->getPDO()->exec("DELETE FROM scheduled_job WHERE job='ConfigurationsUpdateCron'");
    }
}
