...
class V1Dot0Dot106 extends AbstractMigration
{
    /**
     * @inheritDoc
     */
    ...
    {
        echo 'Updating array_values... ' . PHP_EOL;

        $this->getEntityManager()->getPdo()->query("DELETE FROM array_value
            WHERE entity_type='ProductFamily' OR entity_type='Product'");
