...
class V1Dot1Dot30 extends AbstractMigration
{
    /**
     * @inheritDoc
     */
    ...
    {
        echo 'Update angebot marge in configurations... ' . PHP_EOL;
        ...
        $service = $this->getContainer()->get('serviceFactory')->create('UpdateProductPrice');
        foreach ($products as $product) {
            $service->updateProductAngebotMarge($product, true);
        }
